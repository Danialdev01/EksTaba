...
<nav class="bg-white dark:bg-gray-800 dark:text-white antialiased">
    <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0 py-4">
        ...
        <div class="flex items-center space-x-8">
            ...
            <li>
                <a href="<?php echo $location_index?>/guru/" title="" class="flex text-sm font-medium text-gray-900 hover:text-primary-700 dark:text-white dark:hover:text-primary-500">
                Dashboard
                </a>
            </li>
            <li class="shrink-0">
                <a href="<?php echo $location_index?>/guru/kelas/" title="" class="flex text-sm font-medium text-gray-900 hover:text-primary-700 dark:text-white dark:hover:text-primary-500">
                Kelas
                </a>
            </li>
            <li class="shrink-0">
                <a href="<?php echo $location_index?>/guru/kuiz/" title="" class="flex text-sm font-medium text-gray-900 hover:text-primary-700 dark:text-white dark:hover:text-primary-500">
                Kuiz
                </a>
            </li>
            <li class="shrink-0">
                <a href="<?php echo $location_index?>/guru/nota/" title="" class="flex text-sm font-medium text-gray-900 hover:text-primary-700 dark:text-white dark:hover:text-primary-500">
                Nota
                </a>
            </li>
            <!-- <li class="shrink-0">
        ...
        <div class="flex items-center lg:space-x-2">
            ...
            <ul class="p-2 text-start text-sm font-medium text-gray-900 dark:text-white">
                <li><a href="<?php echo $location_index?>/guru/account/" title="" class="inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600"> My Account </a></li>
