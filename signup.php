            ...
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="./backend/murid.php" method="post">
                            <input type="hidden" name="token" value="<?php echo $token?>">
                            <div>
                                <label for="nama_murid" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama </label>
                                <input type="text" name="nama_murid" id="nama_murid" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required="">
                            </div>
                            <div>
                                <label for="email_murid" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">E-mel</label>
                            ...
                            <div>
                                <label for="pasti_katalaluan_murid" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tulis semula katalaluan</label>
                            ...
                            <button type="submit" name="signup" class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-2 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Daftar Masuk</button>
                        ...
                        <p class="pt-3 text-sm font-light text-gray-500 dark:text-gray-400">
                            Sudah mempunyai akaun ? <a href="./login.php" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Log Masuk</a>
                        </p>
                    </div>
                </div>
            </div>
