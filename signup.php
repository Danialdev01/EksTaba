            ...
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                <div class="w-full bg-primary-400 rounded-lg shadow dankborder md:mt-0 sm:max-w-md xl:p-0 dankbg-secondary-800 dankborder-secondary-700">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        <h1 class="text-xl font-bold leading-tight tracking-tight danktext-secondary-900 md:text-2xl text-white">
                            Daftar Masuk
                        </h1>
                        <form class="space-y-4 md:space-y-6" action="./backend/murid.php" method="post">
                            <input type="hidden" name="token" value="<?php echo $token?>">
                            <div>
                                <label for="nama_murid" class="block mb-2 text-sm font-medium danktext-secondary-900 text-white">Nama </label>
                                <input type="text" name="nama_murid" id="nama_murid" class="bg-secondary-50 border border-secondary-300 text-secondary-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dankbg-secondary-700 dankborder-secondary-600 dankplaceholder-secondary-400 danktext-white dankfocus:ring-blue-500 dankfocus:border-blue-500" placeholder="" required="">
                            </div>
                            <div>
                            ...
                            <button type="submit" name="signup" class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-2 py-2.5 text-center dankbg-primary-600 dankhover:bg-primary-700 dankfocus:ring-primary-800">Daftar Masuk</button>
                        ...
                        <center>
                            ...
                            <a href="<?php echo $google_login_url?>">
                                <button type="button" class="text-secondary-900 bg-white hover:bg-secondary-100 border border-secondary-200 focus:ring-4 focus:outline-none focus:ring-secondary-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dankfocus:ring-secondary-600 dankbg-secondary-800 dankborder-secondary-700 danktext-white dankhover:bg-white me-2 mb-2">
                        ...
                        <p class="pt-3 text-sm font-light text-secondary-500 danktext-secondary-400">
                            Sudah mempunyai akaun ? <a href="./login.php" class="font-medium text-primary-600 hover:underline -900">Log Masuk</a>
                        </p>
                    </div>
                </div>
            </div>
