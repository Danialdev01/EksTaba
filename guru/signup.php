                ...
                <div class="w-full bg-primary-400  rounded-lg shadow dankborder md:mt-0 sm:max-w-md xl:p-0 dankbg-secondary-800 dankborder-secondary-700">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" method="post" action="../backend/guru.php">
                            ...
                            <div>
                                <label for="nama_guru" class="block mb-2 text-sm font-medium text-secondary-900 danktext-white">Nama</label>
                                <input type="text" name="nama_guru" id="nama_guru" class="bg-secondary-50 border border-secondary-300 text-secondary-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dankbg-secondary-700 dankborder-secondary-600 dankplaceholder-secondary-400 danktext-white dankfocus:ring-primary-500 dankfocus:border-primary-500" placeholder="" required="">
                            </div>
                            <div>
                        ...
                        <center>
                            ...
                            <!-- <span><p class="text-black danktext-white pb-3">atau</p></span>
