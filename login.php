    ...
    <main class="dankbg-plrimary-200">
        ...
        <section>
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                <div class="w-full bg-white rounded-lg shadow dankborder md:mt-0 sm:max-w-md xl:p-0 dankbg-secondary-800 dankborder-secondary-700">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        <h1 class="text-xl font-bold leading-tight tracking-tight danktext-secondary-900 md:text-2xl">
                            Log Masuk
                        </h1>
                        <form class="space-y-4 md:space-y-6" method="post" action="./backend/murid.php">
                            <input type="hidden" name="token" value="<?php echo $token?>">
                            <div>
                                <label for="email_murid" class="block mb-2 text-sm font-medium danktext-secondary-900">E-mel anda</label>
                            ...
                            <div>
                                <label for="katalaluan_murid" class="block mb-2 text-sm font-medium danktext-secondary-900">Katalaluan</label>
                        ...
                        <center>
                            ...
                            <span><p class="text-black danktext-black pb-3">atau</p></span>
                            <a href="<?php echo $google_login_url?>">
                                <button type="button" class="danktext-black dankhover:text-white bg-white hover:bg-secondary-100 border border-secondary-200 focus:ring-4 focus:outline-none focus:ring-secondary-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dankfocus:ring-secondary-600 dankbg-secondary-800 dankborder-secondary-700 dankhover:bg-secondary-700 me-2 mb-2">
                                    ...
                                    <span class="danktext-black dankhover:text-white">
                                        Log masuk Google
                                    </span>
                                </button>
                            </a>
                        ...
                        <p class="pt-3 text-sm font-light text-secondary-500 danktext-black">
                            Belum mempunyai akaun ? <a href="<?php echo $location_index?>/signup.php" class="font-medium text-primary-600 hover:underline -500">Daftar Masuk</a>
                        </p>
